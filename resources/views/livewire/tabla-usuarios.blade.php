        ...
        <div class="card">
            ...
            <div class="row mt-3 mb-3">
                <div class="col-12 col-sm-3">
                    <button wire:click="$set('crearUsuario', true)" class="btn btn-primary" style="margin-left : 10px">
                        Crear usuario
                    </button>
                </div>
            </div>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <span
                                        class="text-secondary text-xs font-weight-normal">{{ $user->created_at }}</span>
                                </td>
